...
func (s *Storage) DownloadFile(ctx context.Context, objectName string) (io.Reader, error) {
	info, err := s.client.GetObject(ctx, s.bucket, objectName, minio.GetObjectOptions{})
	if err != nil {
